...
class Zend_Http_Client_Adapter_Socket implements Zend_Http_Client_Adapter_Interface, Zend_Http_Client_Adapter_Stream
{
    ...
    public function connect($host, $port = 80, $secure = false)
    {
        ...
        if (! is_resource($this->socket) || ! $this->config['keepalive']) {
            ...
            if ('tls' === $this->config['ssltransport']) {
                $methodBitmask = STREAM_CRYPTO_METHOD_TLSv1_0_SERVER | STREAM_CRYPTO_METHOD_TLSv1_1_SERVER
                    | STREAM_CRYPTO_METHOD_TLSv1_2_SERVER;
                if (!stream_context_set_option($context, 'ssl', 'crypto_method', $methodBitmask)) {
                    #require_once 'Zend/Http/Client/Adapter/Exception.php';
                    throw new Zend_Http_Client_Adapter_Exception('Unable to set crypto_method option');
                }
            }
